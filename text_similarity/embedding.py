...
class Embeddings:
    def __init__(self):
        ...
        self.model_w2v = LoadModel.news_dataframe()
    ...
    def document_word_embeddings(self):
        ...
        for doc_index in range(len(tokenized_paded_documents)):
            for word_index in range(len(tokenized_paded_documents[0])):
                doc_word_embeddings[doc_index][word_index] = embedding_matrix[tokenized_paded_documents[doc_index][word_index]]
    ...
    def document_embeddings(self):
        ...
        for doc_index in range(len(doc_word_embeddings)):
            ...
            documentEmbeddings[i] += embedding_matrix[tokenizer.word_index[words[word_index]]] * tfidf_vectors[doc_index][word_index]       
